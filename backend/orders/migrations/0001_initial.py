    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default=orders.models.generate_reference, max_length=32, unique=True)),
                ...
                ('idempotency_key', models.CharField(blank=True, help_text='Client-supplied key. A retry carrying a key already seen returns the original order instead of creating a second one.', max_length=64, null=True, unique=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('order', 'product'), name='orderitem_unique_product_per_order'),
        ),
        migrations.AddConstraint(
            model_name='orderitem',
